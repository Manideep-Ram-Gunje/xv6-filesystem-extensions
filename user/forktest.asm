...
forktest(void)
{
  ...
  36:	3e650513          	addi	a0,a0,998 # 418 <symlink+0xc>
  ...
  58:	41450513          	addi	a0,a0,1044 # 468 <symlink+0x5c>
  ...
  6e:	3be50513          	addi	a0,a0,958 # 428 <symlink+0x1c>
  ...
  80:	3c450513          	addi	a0,a0,964 # 440 <symlink+0x34>
  ...
  b0:	3ac50513          	addi	a0,a0,940 # 458 <symlink+0x4c>
